...
| 039 | 2026-09-06 | [About you textarea layout](handoffs/039-2026-09-06-about-you-textarea-layout.md) | Positioned About you textarea below heading/description spanning full inline width with vertical-only resizing. |
| 040 | 2026-09-06 | [Archive popup delay and topic background](handoffs/040-2026-09-06-archive-popup-delay-and-topic-bg.md) | Removed floating archive popup delay with 0.1s snappy easing and unified title topic rows with transparent backgrounds. |
| 041 | 2026-09-06 | [Strip unrenderable comments](handoffs/041-2026-09-06-strip-unrenderable-comments.md) | Completely removed unrenderable HTML comments/control markers from notes and views; enhanced MCQ parsing and automated vault note cleanup. |
| 042 | 2026-09-06 | [Center internet tooltip and change color to yellow](handoffs/042-2026-09-06-internet-tooltip-yellow-and-centered.md) | Centered the internet usage tooltip over the globe button and changed the color scheme to luminous yellow with pulsing dot. |
| 043 | 2026-09-06 | [Smoke test dedup and vertical spacing](handoffs/043-2026-09-06-smoke-test-dedup-and-vertical-spacing.md) | Deduplicated smoke test / diagnostic questions in notes and chat view; added comfortable vertical spacing between paragraphs, turns, and individual question items. |
| 044 | 2026-09-06 | [Prevent MCQ scroll jump](handoffs/044-2026-09-06-prevent-mcq-scroll-jump.md) | Prevented scroll jump to top when clicking MCQ options via focus blur handling, eliminating active editor reloading in note writer, and pinning chat view to bottom across message renders and streaming text. |
| 045 | 2026-09-06 | [Prevent send scroll jump](handoffs/045-2026-09-06-prevent-send-scroll-jump.md) | Prevented scroll jump to top when sending a message by replacing whole-container DOM wiping in fillMessages with incremental turn reconciliation and smooth bottom-pinning. |
| 046 | 2026-09-06 | [Auto-approve Pi web search](handoffs/046-2026-09-06-auto-approve-pi-web-search.md) | Configured auto-summary workflow in web-search.json and added --approve flag to Pi RPC invocation to bypass browser curator popups and auto-approve search tool calls. |
